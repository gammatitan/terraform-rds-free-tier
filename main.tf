...
#   To keep this example simple, deploy into the default VPC and its subnets. In real-world usage, you should
...
# Create a subnet group across all the subnets of the default ASG to host the RDS instance
...
# Create a custom parameter group and an option group for configurabulity
